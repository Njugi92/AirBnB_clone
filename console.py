...
class HBNBCommand(cmd.Cmd):
    ...
    def emptyline(self):
        """It does nothing when received an empty line"""
        pass
    ...
    def do_show(self, arg):
        ...
        It displays the string representation of a class instance of given id
        """
        arg1 = parse(arg)
        objdict = storage.all()
        if len(arg1) == 0:
    ...
    def do_destroy(self, arg):
        ...
        It deletes a class instance of a given id
        """
        arg1 = parse(arg)
        objdict = storage.all()
        if len(arg1) == 0:
    ...
    def do_all(self, arg):
        ...
        It displays string representation of all instances of given class
        if no specified class, display all instantiated objects
        """
        arg1 = parse(arg)
    ...
    def do_count(self, arg):
        """Usage: it counts <class> or <class>.count()
        This retrives the number of instances of a given class
        """
        arg1 = parse(arg)
        count = 0
        for obj in storage.all().values():
    ...
    def do_update(self, arg):
        """Usage: it updates <class> <id> <attribute_name> <attribute_value>
        or <class>.update(<id>, <attribute_name>, <attribute_value>) or
        <class>.update(<id>, <dictionary>)
        This updates a class instance of a given id by updating or adding
